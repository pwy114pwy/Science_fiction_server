...
router.post('/api/Addcharacter', async (req, res) => {
  try {
    ...
    let Contribute_1=ContributeList[1]
    let Contribute_1=ContributeList[2]
    let Contribute_1=ContributeList[3]
    let Contribute_1=ContributeList[4]
    let Contribute_1=ContributeList[5]
    let Contribute_1=ContributeList[6]
