...
router.post('/api/Addcharacter', async (req, res) => {
  try {
    ...
    let Contribute_3 = ContributeList[2]?ContributeList[0]:""
    let Contribute_4 = ContributeList[3]?ContributeList[0]:""
    let Contribute_5 = ContributeList[4]?ContributeList[0]:""
