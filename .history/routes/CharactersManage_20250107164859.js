...
router.post('/api/Addcharacter', async (req, res) => {
  try {
    ...
    let Intellect_Ability = AbilityList[1].value?AbilityList[0].value:""
    let Decision_Ability = AbilityList[2].value?AbilityList[0].value:""
    let Influence_Ability = AbilityList[3].value?AbilityList[0].value:""
    let Moral_Ability = AbilityList[4].value?AbilityList[0].value:""
    let Will_Ability = AbilityList[5].value?AbilityList[0].value:""
