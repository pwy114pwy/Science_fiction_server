...
router.post('/api/Addcharacter', async (req, res) => {
  try {
    ...
    console.log(req.body.AbilityList[0].value)
    let Contribute_1 = ContributeList[0]?ContributeList[0]:""
    let Contribute_2 = ContributeList[1]?ContributeList[1]:""
    let Contribute_3 = ContributeList[2]?ContributeList[2]:""
    let Contribute_4 = ContributeList[3]?ContributeList[3]:""
    let Contribute_5 = ContributeList[4]?ContributeList[4]:""
    let Contribute_6 = ContributeList[5]?ContributeList[5]:""

    let Power_Ability = AbilityList[0].value?AbilityList[0].value:""
    let Intellect_Ability = AbilityList[1].value?AbilityList[1].value:""
    let Decision_Ability = AbilityList[2].value?AbilityList[2].value:""
    let Influence_Ability = AbilityList[3].value?AbilityList[3].value:""
    let Moral_Ability = AbilityList[4].value?AbilityList[4].value:""
    let Will_Ability = AbilityList[5].value?AbilityList[5].value:""
