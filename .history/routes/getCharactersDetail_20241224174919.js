...
router.post('/api/getCharacterDetai', async (req, res) => {
  try {
    ...
    const [relationships] = await pool.query(
      'SELECT From_CharacterID,From_Name, To_CharacterID,To_Name, Relation_Type FROM relationships WHERE Illustrated_ID = ?',
      [Illustrated_ID]
    );
