...
router.post('/api/AddDiscussion', async (req, res) => {
  try {
    ...
    const [result] = await pool.query(
      'INSERT INTO comment (Discussion_Parent_ID,Illustrated_ID,Illustrated_Name, Discussion_User_ID, Discussion_User_NickName, Discussion_Content,Discussion_Time) VALUES (?,?,?, ?, ?, ?, ?)', [Discussion_Parent_ID, Illustrated_ID, Comment_User_Name, Comment_User_NickName, Comment_Time, Comment_Content]
    );
    // arr = discussion
