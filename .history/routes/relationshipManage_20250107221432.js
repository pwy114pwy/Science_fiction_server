...
router.post('/api/AddCharacter', async (req, res) => {
  try {
    const { Rela_ID, Illustrated_ID, Illustrated_Name, Role_Name, X_Position, Y_Position, Role_Introduction, Role_Image, Tag, Classic_Quotes, ContributeList, AbilityList } = req.body;
