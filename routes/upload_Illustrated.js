...
// 定义主上传目录和辅助上传目录
const uploadDir = "C:\\Users\\叶\\Desktop\\科幻小说_后台管理\\science_fiction_management\\static\\Illustrated_img";
const secondaryUploadDir = "E:\\uniapp工作空间\\Science _fiction\\static\\Illustrated_img"; // 替换为你的第二个目录路径
...
// 定义图片上传路由
// 定义图片上传路由
router.post('/api/upload_Illustratedimg', upload.single('file'), async (req, res, next) => {
    try {
        if (!req.file) {
